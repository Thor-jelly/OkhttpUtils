...
public class GsonTypes {
    ...
    public static ParameterizedType newParameterizedTypeWithOwner(
        ...
        return new GsonTypes.ParameterizedTypeImpl(ownerType, rawType, typeArguments);
    }
    ...
    public static GenericArrayType arrayOf(Type componentType) {
        return new GsonTypes.GenericArrayTypeImpl(componentType);
    }
    ...
    public static WildcardType subtypeOf(Type bound) {
        ...
        return new GsonTypes.WildcardTypeImpl(upperBounds, EMPTY_TYPE_ARRAY);
    }
    ...
    public static WildcardType supertypeOf(Type bound) {
        ...
        return new GsonTypes.WildcardTypeImpl(new Type[] { Object.class }, lowerBounds);
    }
    ...
    public static Type canonicalize(Type type) {
        if (type instanceof Class) {
            Class<?> c = (Class<?>) type;
            return c.isArray() ? new GsonTypes.GenericArrayTypeImpl(canonicalize(c.getComponentType())) : c;

        } else if (type instanceof ParameterizedType) {
            ParameterizedType p = (ParameterizedType) type;
            return new GsonTypes.ParameterizedTypeImpl(p.getOwnerType(),
                    p.getRawType(), p.getActualTypeArguments());

        } else if (type instanceof GenericArrayType) {
            GenericArrayType g = (GenericArrayType) type;
            return new GsonTypes.GenericArrayTypeImpl(g.getGenericComponentType());

        } else if (type instanceof WildcardType) {
            WildcardType w = (WildcardType) type;
            return new GsonTypes.WildcardTypeImpl(w.getUpperBounds(), w.getLowerBounds());
